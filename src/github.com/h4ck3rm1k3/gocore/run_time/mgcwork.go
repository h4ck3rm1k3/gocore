...
func (b *workbuf) logget(entry int) {
	...
	if b.inuse {
		println("run_time: logget fails log entry=", entry,
...
func (b *workbuf) logput(entry int) {
	...
	if !b.inuse {
		println("run_time:logput fails log entry=", entry,
			"b.log[0]=", b.log[0], "b.log[1]=", b.log[1],
			"b.log[2]=", b.log[2], "b.log[3]=", b.log[3])
...
func (b *workbuf) checknonempty() {
	if b.nobj == 0 {
		println("run_time: nonempty check fails",
			"b.log[0]=", b.log[0], "b.log[1]=", b.log[1],
			"b.log[2]=", b.log[2], "b.log[3]=", b.log[3])
...
func (b *workbuf) checkempty() {
	if b.nobj != 0 {
		println("run_time: empty check fails",
			"b.log[0]=", b.log[0], "b.log[1]=", b.log[1],
			"b.log[2]=", b.log[2], "b.log[3]=", b.log[3])
