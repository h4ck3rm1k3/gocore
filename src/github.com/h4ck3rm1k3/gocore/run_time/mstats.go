...
// and all data after by_size is local to run_time, not exported.
...
//go:linkname readGCStats run_time/debug.readGCStats
...
func readGCStats_m(pauses *[]uint64) {
	p := *pauses
	// Calling code in run_time/debug should make the slice large enough.
