...
func startpanic_m() {
	...
	if mheap_.cachealloc.size == 0 { // very early
		print("run_time: panic before malloc heap initialized\n")
	...
	case 1:
		...
		fallthrough
	case 2:
		// This is a genuine bug in the run_time, we couldn't even
...
func canpanic(gp *g) bool {
	...
	// Yes, as long as it is running Go code, not run_time code,
