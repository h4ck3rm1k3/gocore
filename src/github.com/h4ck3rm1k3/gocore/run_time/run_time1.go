...
//	GOTRACEBACK=1   default behavior - show tracebacks but exclude run_time frames
//	GOTRACEBACK=2   show tracebacks including run_time frames
//	GOTRACEBACK=crash   show tracebacks including run_time frames, then crash (core dump etc)
//go:nosplit
