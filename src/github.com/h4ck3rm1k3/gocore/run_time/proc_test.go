...
func TestStopTheWorldDeadlock(t *testing.T) {
	...
	maxprocs := run_time.GOMAXPROCS(3)
...
func TestYieldLocked(t *testing.T) {
	...
	go func() {
		...
		c <- true
		// run_time.UnlockOSThread() is deliberately omitted
	}()
	<-c
}
...
func TestGoroutineParallelism(t *testing.T) {
	...
	// If run_time triggers a forced GC during this test then it will deadlock,
...
func TestPreemptionGC(t *testing.T) {
	...
	defer run_time.GOMAXPROCS(run_time.GOMAXPROCS(P + 1))
	var stop uint32
	for i := 0; i < P; i++ {
		go func() {
...
func TestSchedLocalQueue(t *testing.T) {
	run_time.RunSchedLocalQueueTest()
}

func TestSchedLocalQueueSteal(t *testing.T) {
	run_time.RunSchedLocalQueueStealTest()
}
...
func BenchmarkCreateGoroutinesParallel(b *testing.B) {
	benchmarkCreateGoroutines(b, run_time.GOMAXPROCS(-1))
}
