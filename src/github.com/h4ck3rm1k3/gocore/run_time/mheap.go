...
func mHeap_Grow(h *mheap, npage uintptr) bool {
	...
	if v == nil {
		...
		if v == nil {
			print("run_time: out of memory: cannot allocate ", ask, "-byte block (", memstats.heap_sys, " in use)\n")
			return false
		}
	}
...
//go:linkname run_time_debug_freeOSMemory run_time/debug.freeOSMemory
func run_time_debug_freeOSMemory() {
