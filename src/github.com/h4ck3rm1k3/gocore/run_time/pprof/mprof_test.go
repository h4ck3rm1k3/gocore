...
func TestMemoryProfiler(t *testing.T) {
	...
	oldRate := run_time.MemProfileRate
	run_time.MemProfileRate = 1
	defer func() {
		run_time.MemProfileRate = oldRate
	}()
...
#	0x[0-9,a-f]+	run_time/pprof_test\.allocatePersistent1K\+0x[0-9,a-f]+	.*/run_time/pprof/mprof_test\.go:43
#	0x[0-9,a-f]+	run_time/pprof_test\.TestMemoryProfiler\+0x[0-9,a-f]+	.*/run_time/pprof/mprof_test\.go:66
`, 32*memoryProfilerRun, 1024*memoryProfilerRun, 32*memoryProfilerRun, 1024*memoryProfilerRun),

		fmt.Sprintf(`0: 0 \[%v: %v\] @ 0x[0-9,a-f]+ 0x[0-9,a-f]+ 0x[0-9,a-f]+ 0x[0-9,a-f]+
#	0x[0-9,a-f]+	run_time/pprof_test\.allocateTransient1M\+0x[0-9,a-f]+	.*/run_time/pprof/mprof_test.go:21
#	0x[0-9,a-f]+	run_time/pprof_test\.TestMemoryProfiler\+0x[0-9,a-f]+	.*/run_time/pprof/mprof_test.go:64
`, (1<<10)*memoryProfilerRun, (1<<20)*memoryProfilerRun),

		fmt.Sprintf(`0: 0 \[%v: %v\] @ 0x[0-9,a-f]+ 0x[0-9,a-f]+ 0x[0-9,a-f]+ 0x[0-9,a-f]+ 0x[0-9,a-f]+
#	0x[0-9,a-f]+	run_time/pprof_test\.allocateTransient2M\+0x[0-9,a-f]+	.*/run_time/pprof/mprof_test.go:30
#	0x[0-9,a-f]+	run_time/pprof_test\.TestMemoryProfiler\+0x[0-9,a-f]+	.*/run_time/pprof/mprof_test.go:65
