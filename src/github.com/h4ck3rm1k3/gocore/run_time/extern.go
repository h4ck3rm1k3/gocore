...
/*
Package run_time contains operations that interact with Go's run_time system,
...
The run_time/debug package's SetGCPercent function allows changing this
percentage at run time. See http://golang.org/pkg/run_time/debug/#SetGCPercent.

The GODEBUG variable controls debug output from the run_time. GODEBUG value is
a comma-separated list of name=val pairs. Supported names are:
	...
	memprofilerate: setting memprofilerate=X will update the value of run_time.MemProfileRate.
...
program fails due to an unrecovered panic or an unexpected run_time condition.
...
// run_time.sigpanic, then pc[i] is the program counter of a faulting
// instruction and should be used without any subtraction.
func Callers(skip int, pc []uintptr) int {
	// run_time.callers uses pc.array==nil as a signal
