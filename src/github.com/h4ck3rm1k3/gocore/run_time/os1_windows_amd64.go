...
func exceptionhandler(info *exceptionrecord, r *context, gp *g) int32 {
	...
	// Only push run_time·sigpanic if r->rip != 0.
	// If r->rip == 0, probably panicked because of a
	// call to a nil func.  Not pushing that onto sp will
	// make the trace look like a call to run_time·sigpanic instead.
	// (Otherwise the trace will end at run_time·sigpanic and we
...
// lastcontinuehandler is reached, because run_time cannot handle
