...
// The profiling signal handler needs to know whether it is executing run_time.gogo.
...
// The value reported will include the padding between run_time.gogo and the
...
func TestRuntimeGogoBytes(t *testing.T) {
	...
	t.Fatalf("go tool nm did not report size for run_time.gogo")
}
...
// the operating system and the run_time can process these faults
