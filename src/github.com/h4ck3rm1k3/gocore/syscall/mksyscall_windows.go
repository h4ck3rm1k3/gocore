...
func syscalldot() string {
	if packageName == "github.com/h4ck3rm1k3/gocore/syscall" {
		return ""
	}
	return "syscall."
}
...
{{template "tmpvars" .}}	{{template "github.com/h4ck3rm1k3/gocore/syscall" .}}
...
{{define "github.com/h4ck3rm1k3/gocore/syscall"}}{{.Rets.SetReturnValuesCode}}{{.Syscall}}(proc{{.DLLFuncName}}.Addr(), {{.ParamCount}}, {{.SyscallParamList}}){{end}}
