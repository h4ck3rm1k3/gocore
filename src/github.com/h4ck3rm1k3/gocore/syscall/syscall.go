...
// portable interface to the system, such as "github.com/h4ck3rm1k3/gocore/os", "github.com/h4ck3rm1k3/gocore/time" and "github.com/h4ck3rm1k3/gocore/net".  Use
...
//go:noescape
func use(p unsafe.Pointer) { panic("no implementationo")}
