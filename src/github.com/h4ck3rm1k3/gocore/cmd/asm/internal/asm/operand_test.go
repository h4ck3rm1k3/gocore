...
var amd64OperandTests = []operandTest{
	...
	{"run_time·_GetStdHandle(SB)", "run_time._GetStdHandle(SB)"},
...
var x86OperandTests = []operandTest{
	...
	{"$0", "$0"},
	{"$0x00000000", "$0"},
	{"$run_time·badmcall(SB)", "$run_time.badmcall(SB)"},
	{"$setg_gcc<>(SB)", "$setg_gcc<>(SB)"},
	{"$~15", "$-16"},
	...
	{"run_time·_NtWaitForSingleObject(SB)", "run_time._NtWaitForSingleObject(SB)"},
	{"s(FP)", "s(FP)"},
	{"sec+4(FP)", "sec+4(FP)"},
...
var armOperandTests = []operandTest{
	...
	{"run_time·_sfloat2(SB)", "run_time._sfloat2(SB)"},
	{"·AddUint32(SB)", "\"\".AddUint32(SB)"},
}
...
var ppc64OperandTests = []operandTest{
	...
	{"$run_time·tlsg(SB)", "$run_time.tlsg(SB)"},
	{"$~3", "$-4"},
	{"(-288-3*8)(R1)", "-312(R1)"},
	{"(16)(R7)", "16(R7)"},
	{"(8)(g)", "8(g)"},
	...
	{"g", "g"},
	{"ret+8(FP)", "ret+8(FP)"},
	{"run_time·abort(SB)", "run_time.abort(SB)"},
	{"·AddUint32(SB)", "\"\".AddUint32(SB)"},
	{"·trunc(SB)", "\"\".trunc(SB)"},
}
...
var arm64OperandTests = []operandTest{
	...
	{"run_time·divWVW(SB)", "run_time.divWVW(SB)"},
	...
	{"$run_time·badsystemstack(SB)", "$run_time.badsystemstack(SB)"},
	{"ZR", "ZR"},
	{"(ZR)", "(ZR)"},
}
