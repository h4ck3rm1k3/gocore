...
import (
	...
	"github.com/h4ck3rm1k3/gocore/cmd/pprof/internal/svg"
...
func PProf(c Completer, interactive **bool, svgpan **string) Commands {
	return Commands{
		...
		"weblist": {c, report.WebList, invokeVisualizer(interactive, awayFromTTY("github.com/h4ck3rm1k3/gocore/html"), "html", browsers()), true, "Output annotated source in HTML for functions matching regexp or address"},
	}
}
