...
var noinst_pkgs = []string{"github.com/h4ck3rm1k3/gocore/sync", "github.com/h4ck3rm1k3/gocore/sync/atomic"}
...
func isforkfunc(fn *Node) bool {
	...
	return myimportpath != "" && myimportpath == "github.com/h4ck3rm1k3/gocore/syscall" && fn.Nname.Sym.Name == "forkAndExecInChild"
}
