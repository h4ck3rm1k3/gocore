...
func branchtag(branch string) (tag string, precise bool) {
	b := run(goroot, CheckExit, "git", "github.com/h4ck3rm1k3/gocore/log", "--decorate=full", "--format=format:%d", "master.."+branch)
	tag = branch
...
func findgoversion() string {
	...
	if !precise {
		...
		tag += chomp(run(goroot, CheckExit, "git", "github.com/h4ck3rm1k3/gocore/log", "-n", "1", "--format=format: +%h %cd", "HEAD"))
	}
...
var buildorder = []string{
	...
	"github.com/h4ck3rm1k3/gocore/container/heap",
	...
	"github.com/h4ck3rm1k3/gocore/fmt",
	"github.com/h4ck3rm1k3/gocore/encoding",
