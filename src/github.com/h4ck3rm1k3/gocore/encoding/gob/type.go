...
// The string for tBytes is "github.com/h4ck3rm1k3/gocore/bytes" not "[]byte" to signify its specialness.
...
var (
	...
	tBytes     = bootstrapType("github.com/h4ck3rm1k3/gocore/bytes", (*[]byte)(nil), 5)
