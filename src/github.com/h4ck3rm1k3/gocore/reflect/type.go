...
type Type interface {
	...
	// that uniquely identifies the package, such as "github.com/h4ck3rm1k3/gocore/encoding/base64".
	...
	// (e.g., base64 instead of "github.com/h4ck3rm1k3/gocore/encoding/base64") and is not
